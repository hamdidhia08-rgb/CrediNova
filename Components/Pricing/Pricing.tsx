...
const plans: Pack[] = [
  ...
  },
  {
    ...
    description:
      "Exclusive premium pack with maximum reliability and golden support.",
    features: [
    ...
    <section className="relative bg-gray-950 text-white py-24 px-6 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto">
        {plans.map((plan) => (
          <div
            key={plan.name}
            className={`relative flex flex-col rounded-2xl p-8 transition-transform duration-300 hover:scale-105
              ${
                plan.gold
