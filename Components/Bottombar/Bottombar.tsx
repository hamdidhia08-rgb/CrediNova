...
export default function MobileBottomBar() {
  ...
  <div className="relative flex justify-around items-center h-16 px-4">
    ...
    {/* Home */}
    <Link href="/dashboard/home" className="flex flex-col items-center text-gray-400 hover:text-blue-500 transition z-10">
      <HomeIcon className="h-6 w-6" />
      <span className="text-xs font-medium mt-1">Home</span>
    </Link>

    {/* My Pack */}
    <Link href="/dashboard/pack" className="flex flex-col items-center text-gray-400 hover:text-yellow-400 transition z-10">
      <CubeIcon className="h-6 w-6" />
      <span className="text-xs font-medium mt-1">My Pack</span>
    </Link>

    {/* My Cards */}
    <Link href="/dashboard/cards" className="flex flex-col items-center text-gray-400 hover:text-green-400 transition z-10">
